...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4 relative">
            {/* Background */}
            <div className="floating-orb w-[500px] h-[500px] top-[-150px] right-[-150px] bg-aurem-500/10" />
            <div className="floating-orb w-[400px] h-[400px] bottom-[-100px] left-[-100px] bg-violet-500/8" style={{ animationDelay: "2s" }} />
            ...
            >
                ...
                <div className="text-center mb-8">
                    <div className="inline-flex w-14 h-14 rounded-2xl bg-gradient-to-br from-aurem-500 to-pink-500 items-center justify-center mb-4 shadow-glow">
                ...
                <div className="glass-panel p-8">
                    ...
                    <p className="text-center text-white/30 text-sm mt-6">
                        ...
                        <Link href="/signup" className="text-aurem-500 hover:text-aurem-400 transition-colors">
                            Sign up
                        </Link>
                    </p>
                </div>
